...
class FightAnalyst:
    ...
    def _rules_section() -> str:
        ...
        return (
            ...
            "Rule 5, PUG commentary requires a threshold AND a reason: Only mention PUGs if ally_count exceeds 20% of friendly_count AND their behavior was the primary factor in the fight outcome. PUG-blame is not a default filler for losses. If stomp discipline, tag discipline, or enemy comp is the bigger story, lead with that and skip PUGs entirely.\n\n"
